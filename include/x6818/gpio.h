...
#ifndef X6818_GPIO_H_
#define X6818_GPIO_H_
...
void gpio_set_pull(struct s5p6818_gpio_reg * gpio, uint32_t pin_no, uint32_t pull);
void gpio_output(struct s5p6818_gpio_reg * gpio, uint32_t pin_no, uint32_t state);
